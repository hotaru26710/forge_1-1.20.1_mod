...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> GALAXY_ORE =
            registerBlock("galaxy_ore",()->new Block(BlockBehaviour.Properties.of().copy(Blocks.DIAMOND_ORE).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> GALAXY_BLOCK =
            registerBlock("galaxy_block",()->new Block(BlockBehaviour.Properties.of().copy(Blocks.DIAMOND_BLOCK).requiresCorrectToolForDrops()));
